...
iso_application="Engine Linux Live/USB"
install_dir=arch
work_dir=work
out_dir=out
gpg_key=
...
[[ -e $script_path/airootfs/usr/lib/os-release-engine ]] && sed -i "s/\(VERSION_ID\)=.*/\1=$iso_version/g" $script_path/airootfs/usr/lib/os-release-engine
